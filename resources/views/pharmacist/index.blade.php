...
<div class="row justify-content-center" style="background-color: #f0f0f0;">
  <div class="col-md-10" style="margin-top: 20px;margin-right: 30px;margin-left: 50px; font-weight: lighter;">
    <div class="row">
      <div class="col-sm-4">
        <h3><a href="/pharmacist" class="text-info">Pharmacist List</a></h3>
      </div>
      <div class="col-sm-8">
        <h3><a href="{{ url('/pharmacist/create') }}" class="btn btn-info"><span class="fa fa-plus"></span> Add Pharmacist </a></h3>
      </div>
    </div>
    @if(session('info'))
