                ...
                <div class="card-text">
                   <form method="post" action="/nurse/{{ $nurse->id }}">
                      ...
                      <div class="form-inline" style="margin-bottom: 20px;">
                        ...
                        <input type="tetx" name="username" class="form-control " required style="width:500px;  " value="{{ $nurse->username }}">
                    </div>
                    <div class="form-inline" style="margin-bottom: 20px;">
                        <label for="email">E-mail</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="email" name="email" class="form-control " required style="width:500px;  " value="{{ $nurse->email }}">
                    </div>

                    <div class="form-inline" style="margin-bottom: 20px;">
                        <label for="phone">Phone</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="text" name="phone" class="form-control" required style="width:500px;"  value="{{ $nurse->phone }}">
                    </div>
                    <div class="form-inline" style="margin-bottom: 20px;">
                        <label for="address">Address</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="text" name="address" class="form-control" required style="width:500px;"  value="{{ $nurse->address }}">
                    </div>
                </div>
