...
<div class="row justify-content-center" style="background-color: #f0f0f0;">
  <div class="col-md-10" style="margin-top: 20px;margin-right: 30px;margin-left: 50px; font-weight: lighter;">
    <div class="row">
      <div class="col-sm-4">
        <h3><a href="/accountant" class="text-info">Accountant List</a></h3>
      </div>
      <div class="col-sm-8">
        <h3><a href="{{ url('/accountant/create') }}" class="btn btn-info"><span class="fa fa-plus"></span> Add Accountant </a></h3>
      </div>
    </div>
    @if(session('info'))
            ...
            <div class="table-responsive">
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td><a href="/accountant/{{ $accountant->id }}/edit" class="btn btn-primary">Edit</a></td>
                  <td><a href="/delete/accountant/{{ $accountant->id }}" class="btn btn-danger" onClick="return myFunction()">Delete</a></td>
                </tr>
                @endforeach
              </table>
              <script>
