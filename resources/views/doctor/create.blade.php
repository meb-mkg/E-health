...
<div class="row justify-content-center" style="background-color: #f0f0f0;">
  <div class="col-sm-12" style="margin-top: 20px;margin-right: 30px;margin-left: 50px;">
    <div class="row">
      <div class="col-sm-4">
        <h3><a href="/doctor">Doctor List</a></h3>
      </div>
      <div class="col-sm-8">
        <h3><a href="/doctor/create" class="btn btn-primary"><span class="fa fa-plus"></span> Add Doctor </a></h3>
      </div>
    </div>
          ...
          <div class="card-text">
            <form method="post" action="/doctor">
              ...
              <div class="form-group" style="margin-bottom: 20px;">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="submit" name="add" value="Add Doctor" class="btn btn-primary  pull-center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              </div>
