                ...
                <div class="card-text">
                   <form method="post" action="/doctor/{{ $doctor->id }}">
                      ...
                      <div class="form-inline" style="margin-bottom: 20px;">
                        ...
                        <input type="tetx" name="username" class="form-control " required style="width:500px;  " value="{{ $doctor->username }}">
                    </div>
                    <div class="form-inline" style="margin-bottom: 20px;">
                        <label for="email">E-mail</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="email" name="email" class="form-control " required style="width:500px;  " value="{{ $doctor->email }}">
                    </div>
                    
                    <div class="form-inline" style="margin-bottom: 20px;">
                        <label for="phone">Phone</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="text" name="phone" class="form-control" required style="width:500px;"  value="{{ $doctor->phone }}">
                    </div>
                    <div class="form-inline" style="margin-bottom: 20px;">
                        <label for="address">Address</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="text" name="address" class="form-control" required style="width:500px;"  value="{{ $doctor->address }}">
                    </div>
                </div>
